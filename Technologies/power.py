# 
# This script generates the value of energy generated by the technologies related to Power
# 
...
def get_solar_power(latitude, longitude, cellSize, scenario): #before get_solar_power_gen(lat, lon, area)
	...
	def pv_watts_get(sys_cap, lat, lon, array_type, time_frame='monthly', mod_type=1, losses=14.08, tilt=20, azimuth=180):
		...
		my_api_key = '4PcPxtelLSXiMuT7e2fus9v2nPCi5mgV5h0W0UPm' #Ana's 'HL6NnxupaYwtWc2K8oJfwYkrsoJGRvGAaz2sfdBz'
...
#If the API doesn't work use this dictionary
#SolarPanelDict = {0: {'system_capacity_kW': 420.0, 'latitude': 20.770724, 'longitude': -103.371491, 'scenario': 0, 'annual_generation_kWh': 770956.4375, 'monthly_generation_kWh': [62646.95703125, 62704.15234375, 73105.171875, 70749.046875, 67732.546875, 59311.3359375, 60621.921875, 62949.44140625, 59521.15625, 64834.88671875, 64964.671875, 61815.11328125], 'energy density [J/m^3]': 1.5e-06, 'GHG emissions (gCO2e/MJ)': 11.4, 'area (m^2)': 2000.0}, 1: {'system_capacity_kW': 420.0, 'latitude': 20.770724, 'longitude': -103.371491, 'scenario': 1, 'annual_generation_kWh': 1217299.64, 'monthly_generation_kWh': [98916.25, 99006.56, 115429.22, 111709.02, 106946.13, 93649.48, 95718.82, 99393.85, 93980.77, 102370.87, 102575.8, 97602.81], 'energy density [J/m^3]': 1.5e-06, 'GHG emissions (gCO2e/MJ)': 11.4, 'area (m^2)': 2000.0}, 2: {'system_capacity_kW': 420.0, 'latitude': 20.770724, 'longitude': -103.371491, 'scenario': 2, 'annual_generation_kWh': 3854782.19, 'monthly_generation_kWh': [313234.79, 313520.76, 365525.86, 353745.23, 338662.73, 296556.68, 303109.61, 314747.21, 297605.78, 324174.43, 324823.36, 309075.57], 'energy density [J/m^3]': 1.5e-06, 'GHG emissions (gCO2e/MJ)': 11.4, 'area (m^2)': 2000.0}}